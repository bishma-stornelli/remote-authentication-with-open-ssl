...
insecure-server: serv-acceso.o options-server.o helper.o
	$(CC) -O serv-acceso.o options-server.o helper.o -o serv-acceso
...
insecure-server.o: server-acceso.c options-server.o helper.o
